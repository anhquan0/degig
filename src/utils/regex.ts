...
const twitterRegex = new RegExp(`^(?:https?:\\/\\/)?(?:www\\.)?(twitter\\.com|x\\.com)\\/${twitterUsernameRegex.source}\\/?$`);

// allows normal username and group links
const telegramRegex = new RegExp(
  `^(?:https?:\\/\\/)?(?:www\\.)?(?:t\\.me|telegram\\.me)\\/(?:${telegramUsernameRegex.source}|\\+[a-zA-Z0-9_-]+)\/?$`,
);
