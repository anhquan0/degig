...
export const allSubSkills = Object.values(skillSubSkillMap).flatMap((skills) => skills.map((s) => s.value)) as [SubSkillsType, ...SubSkillsType[]];
export const allSkills = Object.keys(skillSubSkillMap) as [keyof typeof skillSubSkillMap];
