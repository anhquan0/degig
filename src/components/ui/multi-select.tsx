      ...
      >
        ...
        >
          <div className="relative">
            <div className="relative flex flex-wrap gap-1 pr-5">
              {selected.map((option) => {
                return (
                  <Badge
                    key={option.value}
                    variant="secondary"
                    className={cn(badgeClassName, option.hidden && 'hidden')}
                  ...
                  >
                    ...
                    <button
                      className={cn(
                        'ring-offset-background ml-1 rounded-full outline-hidden focus:ring-2 focus:ring-offset-2',
